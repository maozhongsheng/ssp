...
//,"/api/user/saveInfo"
private String [] whitelist = {"/api/user/login","/api/userIdByToken","/api/selectUpperBySlotId","/api/adminIndexSlotId","/api/adminSelectMediaName","/api/adminSelectSlotName","/api/adminSelectSspCompanyName","/api/adminSelectSlotTypeName","/api/mediaNameList"
        ,"/api/sspIndexSlotId","/api/sspIndexMediaId","/api/sspSelectMediaName","/api/sspSelectSlotName","/api/sspSelectSlotTypeName","/api/mediaByTagid","/api/agentByMediaId"};
